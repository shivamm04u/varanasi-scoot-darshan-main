...
// LOCAL IMAGE IMPORTS
// Ensure these files exist in src/assets/locations/
...
const locations = [
  {
    ...
    image: kashiImg,
    tag: "Spiritual Heart",
    // Smart Link: Searches Google Maps directly (Always works)
    mapLink: "https://www.google.com/maps/search/?api=1&query=Kashi+Vishwanath+Temple+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Kashi+Vishwanath+Temple+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
  ...
  },
  {
    ...
    fullDesc: "Dashashwamedh Ghat is the main ghat in Varanasi on the Ganga River. It is located close to Vishwanath Temple and is probably the most spectacular ghat. Two Hindu legends are associated with it: according to one, Lord Brahma created it to welcome Lord Shiva.",
    image: gangaImg,
    tag: "Ganga Aarti",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Dashashwamedh+Ghat+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Dashashwamedh+Ghat+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
  ...
  },
  {
    ...
    fullDesc: "Manikarnika Ghat is one of the holiest cremation grounds among the sacred riverfronts (ghats), alongside the river Ganges, in the city of Varanasi. In Hinduism, death is considered as a gateway to another life marked by the result of one's karma.",
    image: manikarnikaImg,
    tag: "Moksha",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Manikarnika+Ghat+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Manikarnika+Ghat+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
  ...
  },
  {
    ...
    fullDesc: "Assi Ghat is the southernmost ghat in Varanasi. To most visitors to Varanasi, it is known for being a place where long-term foreign students, researchers, and tourists live. It is one of the ghats often visited for recreation and during festivals.",
    image: assiImg,
    tag: "Morning Vibes",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Assi+Ghat+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Assi+Ghat+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
    timings: "Open 24 Hours"
  },
  {
    id: 5,
    ...
    fullDesc: "Tulsi Ghat is one of the ghats in Varanasi. It is named after Tulsidas who lived there while he wrote the Ramcharitmanas. Earlier, it was known as Lolark Ghat.",
    image: tulsiImg,
    tag: "History",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Tulsi+Ghat+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Tulsi+Ghat+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
    timings: "Open 24 Hours"
  },
  {
    id: 6,
    ...
    image: durgaImg,
    tag: "Shakti Peeth",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Durga+Mandir+Varanasi",
  ...
  },
  {
    ...
    fullDesc: "Tulsi Manas Mandir is one of the most famous temples in Varanasi. The temple is dedicated to Lord Rama. It was constructed in 1964 by the Birla family of Howrah.",
    image: tulsiManasImg,
    tag: "Ramayana",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Tulsi+Manas+Mandir+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Tulsi+Manas+Mandir+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
  ...
  },
  {
    ...
    fullDesc: "Tridev Mandir is a beautiful temple located near Tulsi Manas Mandir. It is dedicated to the holy trinity of Hinduism: Brahma (The Creator), Vishnu (The Preserver), and Mahesh (The Destroyer).",
    image: tridevImg,
    tag: "Divinity",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Tridev+Mandir+Varanasi",
  ...
  },
  {
    ...
    fullDesc: "Mani Mandir is a relatively newer but architecturally stunning temple located in the Durgakund area. It is known for its peaceful environment and beautiful idols.",
    image: maniImg,
    tag: "Peace",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Mani+Mandir+Varanasi",
  ...
  },
  {
    ...
    fullDesc: "Sankat Mochan Hanuman Temple is a Hindu temple in Varanasi, Uttar Pradesh, India and is dedicated to the Hindu God Hanuman. The temple was established by famous Hindu preacher and poet saint Sri Goswami Tulsidas.",
    image: sankatImg,
    tag: "Devotion",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Sankat+Mochan+Hanuman+Temple+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Sankat+Mochan+Hanuman+Temple+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
    timings: "5:00 AM – 10:00 PM"
  },
  {
    id: 11,
    ...
    fullDesc: "Shri Vishwanath Mandir also known as VT is one of the most famous tourist places in Varanasi. The temple is dedicated to Lord Shiva and is located in the Banaras Hindu University.",
    image: bhuImg,
    tag: "Architecture",
    mapLink: "https://www.google.com/maps/search/?api=1&query=New+Vishwanath+Temple+BHU+Varanasi",
    embedMap: "https://maps.google.com/maps?q=New+Vishwanath+Temple+BHU+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
  ...
  },
  {
    ...
    fullDesc: "Kabir Math is located at Kabir Chaura, Varanasi. It is the place of residence of the famous saint Kabir Das. It contains the Samadhi Mandir (tomb) of Kabir.",
    image: kabirImg,
    tag: "Harmony",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Kabir+Chaura+Math+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Kabir+Chaura+Math+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
    timings: "6:00 AM – 8:00 PM"
  },
  {
    id: 13,
    ...
    fullDesc: "The Bada Ganesh Temple is located near the Lohatia area. It houses a gigantic statue of Lord Ganesh with a silver face. It is believed that visiting this temple removes obstacles.",
    image: ganeshImg,
    tag: "Beginnings",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Bada+Ganesh+Temple+Varanasi",
  ...
  },
  {
    ...
    fullDesc: "Sarnath is a place located 10 kilometres north-east of Varanasi near the confluence of the Ganges and the Varuna rivers. The deer park in Sarnath is where Gautama Buddha first taught the Dharma.",
    image: sarnathImg,
    tag: "Buddhist Heritage",
    mapLink: "https://www.google.com/maps/search/?api=1&query=Sarnath+Varanasi",
    embedMap: "https://maps.google.com/maps?q=Sarnath+Varanasi&t=&z=15&ie=UTF8&iwloc=&output=embed",
          ...
          {locations.map((location) => (
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-4 right-4 z-20 bg-white/90 p-2 rounded-full shadow-lg text-primary transform translate-y-10 group-hover:translate-y-0 transition-transform duration-300 hover:bg-primary hover:text-white" title="View Details">
