...
import { MapPin, Navigation, X, Clock, Info, Star } from "lucide-react";
...
// Enhanced Data Structure with Descriptions & Embed Maps
const locations = [
  {
    id: 1,
    name: "Kashi Vishwanath Temple",
    description: "One of the most famous Hindu temples dedicated to Lord Shiva. A must-visit spiritual center.",
    fullDesc: "Kashi Vishwanath Temple is one of the most famous Hindu temples dedicated to Lord Shiva. It is located in Varanasi, Uttar Pradesh, India. The temple stands on the western bank of the holy river Ganga, and is one of the twelve Jyotirlingas, the holiest of Shiva Temples.",
    image: kashiImg,
    tag: "Spiritual Heart",
  ...
  },
  {
    ...
    fullDesc: "Tulsi Ghat is one of the ghats in Varanasi. It is named after Tulsidas who lived there while he wrote the Ramcharitmanas. Earlier, it was known as Lolark Ghat. It was in the year 1941 that Tulsi Ghat was made concrete and cemented by Baldeo Das Birla.",
    image: tulsiImg,
    tag: "History",
  ...
  },
  {
    ...
    fullDesc: "Durga Mandir is one of the most famous temples in the holy city of Varanasi. This temple has great religious importance for Hinduism and is dedicated to the Maa Durga. The temple was constructed in the 18th century by Bengali Maharani.",
    image: durgaImg,
    tag: "Shakti Peeth",
  ...
  },
  {
    ...
    fullDesc: "Tulsi Manas Mandir is one of the most famous temples in Varanasi. The temple is dedicated to Lord Rama. It was constructed in 1964 by the Birla family of Howrah. The temple is made up of white marble and landscaping all around it.",
    image: tulsiManasImg,
    tag: "Ramayana",
  ...
  },
  {
    ...
    fullDesc: "Tridev Mandir is a beautiful temple located near Tulsi Manas Mandir. It is dedicated to the holy trinity of Hinduism: Brahma (The Creator), Vishnu (The Preserver), and Mahesh (The Destroyer). The architecture is intricate and the ambiance is serene.",
    image: tridevImg,
    tag: "Divinity",
  ...
  },
  {
    ...
    fullDesc: "Mani Mandir is a relatively newer but architecturally stunning temple located in the Durgakund area. It is known for its peaceful environment and beautiful idols. A great place for meditation away from the main city crowds.",
    image: maniImg,
    tag: "Peace",
  ...
  },
  {
    ...
    fullDesc: "Sankat Mochan Hanuman Temple is a Hindu temple in Varanasi, Uttar Pradesh, India and is dedicated to the Hindu God Hanuman. The temple was established by famous Hindu preacher and poet saint Sri Goswami Tulsidas in the early 16th century.",
    image: sankatImg,
    tag: "Devotion",
  ...
  },
  {
    ...
    fullDesc: "Shri Vishwanath Mandir also known as VT is one of the most famous tourist places in Varanasi. The temple is dedicated to Lord Shiva and is located in the Banaras Hindu University. It has the tallest temple tower in the world.",
    image: bhuImg,
    tag: "Architecture",
  ...
  },
  {
    ...
    fullDesc: "Kabir Math is located at Kabir Chaura, Varanasi. It is the place of residence of the famous saint Kabir Das. It contains the Samadhi Mandir (tomb) of Kabir and is a place of immense peace, reflecting the philosophy of unity and simplicity.",
    image: kabirImg,
    tag: "Harmony",
  ...
  },
  {
    ...
    fullDesc: "The Bada Ganesh Temple is located near the Lohatia area. It houses a gigantic statue of Lord Ganesh with a silver face. It is believed that visiting this temple removes obstacles and brings good fortune.",
    image: ganeshImg,
    tag: "Beginnings",
  ...
  },
  {
    ...
    fullDesc: "Sarnath is a place located 10 kilometres north-east of Varanasi near the confluence of the Ganges and the Varuna rivers. The deer park in Sarnath is where Gautama Buddha first taught the Dharma. It features the Dhamek Stupa and the Ashoka Pillar.",
    image: sarnathImg,
